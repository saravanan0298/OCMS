...
<li>  <a href="JavaCourseMaterial.jsp" class="active">Course Material</a><li>
    ...
    <center>
        ...
        <table border="2">
            ...
            <%
                ...
                String sql="select *from javamaterial";
                ...
                <tr>
                    ...
                    <td><a href="JavaDownloadServlet?fileName=<%=rs.getString(3)%>">Download</a></td>
                </tr>
                <%
                }
                %> 
